              ...
              <div style={{ border: '1.5px solid #BFE0D3', background: '#F4FAF7', borderRadius: 14, padding: '18px 20px', marginBottom: 22 }}>
                ...
                <div style={{ borderTop: '1px solid #DCEDE5', marginTop: 12, paddingTop: 13 }}>
                  ...
                  <div style={{ color: MUTED, fontWeight: 700, fontSize: 12.8, lineHeight: 1.9 }}>
                    ...
                    وقراءة بنودك مع ما يُطلب تعديله. <b style={{ color: GREEN }}>رسمٌ ثابت واحد مقابل عملٍ يُسلَّم — لا نسبةَ من تمويلك ولا عمولةَ من أي جهة.</b>
                  </div>
                  {/* حارسٌ للعقود الصغيرة: جاءنا عقدٌ قيمته خمسون ألفاً فصار السعر
                      يساوي العقد. ولا نخترع له رقماً — بل نقول له الحقيقة ونسأله. */}
                  {valIdx === 0 && (
                    <div style={{ color: '#8A6D1F', fontWeight: 700, fontSize: 12.5, lineHeight: 1.9, marginTop: 10 }}>
                      وإن كان عقدك في أسفل هذه الشريحة — بمئات الآلاف أو أقل — فالغالب أن مسارك رأس
                      مال عامل لا تمويل عقد. اكتب لنا قيمته بالضبط ونصدُقك القول قبل أن ندخل معك.
                    </div>
                  )}
                </div>
              </div>
