...
export async function POST() {
  ...
  try {
    const prompt = 'أنت محلل تمويل سعودي خبير. ابحث في الويب عن المنتجات التمويلية المتاحة حالياً للشركات في السعودية من البنوك وشركات التمويل المرخصة من البنك المركزي السعودي.\n\n'
