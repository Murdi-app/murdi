...
export async function POST(req: Request) {
  ...
  const prompt = 'أنت تكتب نيابةً عن د. عبدالحكيم المرضي — مستشار مالي سعودي معتمد، دكتوراه إدارة أعمال، عضوية البورد الأمريكي، 15 سنة خبرة، عبر شركة حلول المرضي للاستشارات المالية. '
    ...
    + (si && si.inputs && Object.keys(si.inputs).length > 0 ? (
        ...
        + 'اطرح مخصص الديون المشكوك فيها (doubtful_debt) من الذمم المدينة لإظهار صافيها في المركز المالي، واحمل المخصص كمصروف في قائمة الدخل. وأوصِ صراحةً في الإيضاحات بإعداد جدول أعمار الذمم المدينة عند الاعتماد (كمستند مساند لا يدخل في متن القوائم). قدّم القوائم مكتملة بالأرقام لا كهيكل فارغ. أي بند غير مُدخل، عالجه بمنطق محاسبي سليم أو أشر إليه صراحة كبند يحتاج استكمالاً، دون اختلاق رقم.\\n'
      ) : '')
