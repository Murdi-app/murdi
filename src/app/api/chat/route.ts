...
${isDeep
  ? 'قدّم تحليلاً عميقاً وخطة عملية محددة بالأرقام والخطوات القابلة للتنفيذ. اربط تحليلك بأرقام الشركة وواقع قطاع المقاولات السعودي. لغة عربية سعودية واضحة ومهنية.'
