...
export async function POST(req: Request) {
  ...
  const { error: fdError } = await supabase.from('financial_data').insert({
    ...
    owner_nationality: body.owner_nationality ?? null,
    has_parent_company: body.has_parent_company ?? null,
    parent_company_country: body.parent_company_country ?? null,
    parent_can_guarantee: body.parent_can_guarantee ?? null,
    supplier_countries: body.supplier_countries ?? null,
