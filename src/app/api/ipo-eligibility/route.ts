...
async function searchEligibility(rev: number, profit: number, years: number, market: string): Promise<string> {
  const prompt = 'انت كبير مستشاري جاهزية الطرح في فريق د. عبدالحكيم المرضي بمنصة مُرضي، خبير بمتطلبات هيئة السوق المالية وتداول والسوق الموازي نمو. '
    ...
    + 'السوق الموازي نمو: الحد الادنى لراس المال المدفوع 10 ملايين ريال، سنة مالية واحدة على الاقل، نسبة الطرح 20% كحد ادنى، عدد المساهمين العموميين لا يقل عن 50 مساهما، لا يشترط تحقيق ارباح. '
    + 'السوق الرئيسي تاسي: الحد الادنى لراس المال المدفوع 300 مليون ريال، 3 سنوات نشاط تشغيلي متصلة، سجل ربحية مستقر، نسبة الطرح 30% كحد ادنى، عدد المساهمين العموميين لا يقل عن 200 مساهم. '
