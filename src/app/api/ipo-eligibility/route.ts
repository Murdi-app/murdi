...
async function searchEligibility(rev: number, profit: number, years: number, market: string): Promise<string> {
  const prompt = 'انت كبير مستشاري جاهزية الطرح في فريق د. عبدالحكيم المرضي بمنصة مُرضي، خبير بمتطلبات هيئة السوق المالية وتداول والسوق الموازي نمو. '
    + 'استخدم هذه الارقام الرسمية الثابتة المعتمدة ولا تغيرها ولا تجتهد فيها ابدا: '
    + 'السوق الموازي نمو: القيمة السوقية الاجمالية المتوقعة عند الادراج لا تقل عن 10 ملايين ريال، نشاط تشغيلي سنة واحدة على الاقل، نسبة الطرح 20% من الاسهم او 30 مليون ريال ايهما اقل، عدد المساهمين من الجمهور لا يقل عن 50 مساهما، لا يشترط تحقيق ارباح، تعيين مستشار مالي الزامي. '
    + 'السوق الرئيسي تاسي: القيمة السوقية الاجمالية المتوقعة عند الادراج لا تقل عن 300 مليون ريال، قوائم مالية مدققة لثلاث سنوات مالية متتالية وفق معايير IFRS، سجل ربحية مستقر، نسبة الطرح 30% كحد ادنى، عدد المساهمين من الجمهور لا يقل عن 200 مساهم، تعيين مستشار مالي الزامي. '
    + 'هذه الارقام نهائية وملزمة في كل اجاباتك، لا ترفعها ولا تخفضها. '
