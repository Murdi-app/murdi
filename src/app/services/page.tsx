...
export const metadata: Metadata = {
  ...
  description:
    'تمويل العقد وإصدار ضماناته · دراسة الجدوى الائتمانية · إعداد القوائم المالية · تجهيز ملف التمويل والمخاطبة · لوائح الحوكمة · التقييم العادل · الاعتمادات المستندية وتمويل الذمم. أسعار ومدد معلنة، عبر حلول المرضي للاستشارات المالية — ترخيص FL-457927015.',
