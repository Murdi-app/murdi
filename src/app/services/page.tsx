...
export const metadata: Metadata = {
  ...
  description:
    'تمويل العقد وإصدار ضماناته · دراسة الجدوى الاقتصادية والائتمانية · إعداد القوائم المالية · تجهيز ملف التمويل والمخاطبة · لوائح الحوكمة · التقييم العادل · الاعتمادات المستندية وتمويل الذمم. أسعار ومدد معلنة، عبر حلول المرضي للاستشارات المالية — ترخيص FL-457927015.',
  alternates: { canonical: 'https://murdi.sa/services' },
  openGraph: {
    title: 'خدمات مُرضي | تأهيل المنشآت لرأس المال',
    // العدد يُقرأ من الفهرس لا يُكتب بالحروف: كُتب «سبع عشرة» يوم كانت
    // سبع عشرة، فلمّا صارت ثماني عشرة تخلّف الوصف عن الصفحة تحته.
    description: SERVICE_COUNT + ' خدمة بسعر معلن ومدة معلومة — كل واحدة تُزيل عائقاً بعينه بين ملفك وبين من يموّلك.',
    ...
    <div className="sv" dir="rtl">
      ...
      <div className="sv-wrap">
        ...
        <section>
          ...
          <p className="sv-sec-p">
            هذه لا تُباع بالوصف بل بالدليل. التقييم مجاناً، وبعدهما نقول لك بالأرقام أيّها يخصّك —
        ...
        <p className="sv-foot">
          الأسعار أعلاه لا تشمل ضريبة القيمة المضافة. ويظهر لك قبل التعاقد نطاق العمل والأتعاب كاملة؛ وقد تتكوّن بعض الخدمات من دفعة تجهيز وأتعاب خدمة ممتدة مقابل المتابعة والتفاوض ومراجعة الشروط حتى الصرف أو إغلاق الصفقة، وفق العقد.
