...
export default function Home() {
  ...
  const steps = [
    ...
    { n: '04', t: 'نفتح لك الطريق', d: 'نبيّن لك الجهات التي تنطبق عليك شروطها، ونجهّز ملفك، ونعرضه عليها بتكليفٍ منك ونتابع الرد.' },
  ]

  const opens = [
    { t: 'مطابقة على مستوى المنتج', d: 'البنك الواحد يطرح منتجات مختلفة، وقد تُرفض في واحد وتُقبل في آخر. نبيّن لك المنتج الصحيح لا الاسم وحده.' },
    ...
    { t: 'لا تدفع قبل أن تعرف', d: 'التقييم مجاناً. تعرف أين تقف وكم جهة تنطبق شروطها عليك قبل أن يُطلب منك ريال واحد.' },
  ]
      ...
      <div className="lp">
        ...
        <section className="hero">
          <div className="hero-in">
            ...
            <div className="cta-note">التقييم مجاناً. وبعده تختار: الحكم الائتماني لمنشأتك بـ 990 ر.س تعرف به جهاتك بأسمائها وما ينقصك عند كل واحدة، أو تجهيز الملف والمخاطبة بـ 7,900 ر.س ويُخصم منها الحكم. رسمٌ ثابت واحد مقابل عملٍ يُسلَّم — لا نسبةَ من تمويلك، ولا ريالَ واحد من أي جهة ممولة.</div>
          </div>
        </section>
        ...
        <section className="sec">
          <div className="sec-head">
            ...
            <p>لكل مسار محرك تقييم خاص، وقراءةٌ للجهات التي تنطبق عليك شروطها في حالتك تحديداً.</p>
          </div>
          <div className="grid3">
            {paths.map(p => (
