      ...
      <div className="lp">
        ...
        <section className="hero">
          <div className="hero-in">
            ...
            <div className="cta-note">الاشتراك 2,900 ر.س لأربعة أشهر يفتح مطابقة الجهات ورفع ملفك إليها ومتابعة الرد، مع استشارات مفتوحة وأسئلة مباشرة مع د. عبدالحكيم والفريق.</div>
          </div>
        </section>
