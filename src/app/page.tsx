      ...
      <div className="lp">
        ...
        <section className="hero">
          <div className="hero-in">
            ...
            <div className="cta-note">التقييم مجاناً. وبعده تختار: الحكم الائتماني لمنشأتك بـ 990 ر.س، أو تجهيز الملف والمخاطبة ابتداءً من 7,900 ر.س ويُخصم منها الحكم. تعرف نطاق العمل والأتعاب كاملة قبل التعاقد، ولا نتقاضى مقابلاً من أي جهة ممولة.</div>
          </div>
        </section>
