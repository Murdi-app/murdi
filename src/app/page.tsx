      ...
      <div className="lp">
        ...
        <section className="hero">
          <div className="hero-in">
            ...
            <div className="cta-note">التقييم والمطابقة مجاناً. وبعدهما تختار: الحكم الائتماني لمنشأتك بـ 990 ر.س تعرف به جهاتك بأسمائها وما ينقصك عند كل واحدة، أو تجهيز الملف والمخاطبة والتفاوض بـ 7,900 ر.س ويُخصم منها الحكم. وأتعاب النجاح لا تُدفع إلا بعد صرف التمويل إلى حسابك.</div>
          </div>
        </section>
