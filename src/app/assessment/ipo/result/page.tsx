        ...
        {fdRaw && (() => {
          ...
          <div className="rounded-3xl p-7 text-center" style={{ background: '#1A3D34' }}>
            ...
            <p className="text-[#CFE0DA] text-sm font-bold leading-loose mb-4">
              ...
              نبحث لك في مستشاري الطرح ومتعهدي التغطية والجهات المنظمة، ونستخرج <span style={{ color: '#C9A84C' }}>المنتج المحدَّد</span> الذي تتأهل له في كل جهة — لا اسم الجهة فقط.
