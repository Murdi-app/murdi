...
export default function IntakePage() {
  const [who, setWho] = useState({ full_name: '', phone: '', email: '', company_name: '', city: '', sector: '' })
  ...
  return (
    <div dir="rtl" style={{ background: '#F7FAF9', minHeight: '100vh', fontFamily: 'Cairo, sans-serif' }}>
      <AdminNav />
      <div style={{ maxWidth: 1000, margin: '0 auto', padding: '24px 16px 60px' }}>
        <h1 style={{ color: GREEN, fontSize: 23, fontWeight: 900, margin: '0 0 4px' }}>عميل من مكالمة</h1>
        <p style={{ color: MUTED, fontSize: 13, fontWeight: 700, lineHeight: 1.9, margin: '0 0 20px' }}>
