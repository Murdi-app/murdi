...
export default function ConsultationPanel() {
  ...
  const sendEditRequest = async () => {
    ...
    setSendingE(false);
    if (error) { alert('تعذّر إرسال طلب التعديل — حاول مرة أخرى أو راسلنا واتساب على 0570749196'); return; }
    setEditReason('');
    ...
    <div dir="rtl">
      ...
      <div className="max-w-2xl mx-auto space-y-6 px-4 py-10">
        ...
        <div className="bg-white rounded-3xl p-7 shadow-sm border border-[#E8F5EF]">
          ...
          <a href="https://wa.me/966570749196?text=السلام%20عليكم،%20أحتاج%20مساعدة%20بخصوص%20منصة%20مُرضي" target="_blank" rel="noopener noreferrer"
