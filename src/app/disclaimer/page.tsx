    ...
    <div style={{minHeight:'100vh',background:'#F4F8F6',direction:'rtl',fontFamily:'system-ui,-apple-system,Segoe UI,Tahoma,Arial'}}>
      ...
      <div style={{maxWidth:'860px',margin:'0 auto',padding:'48px 24px 80px'}}>
        ...
        <section style={{marginBottom:'28px'}}>
          ...
          <div style={{color:'#3A4D47',fontSize:'15px',lineHeight:2}}>تقدّم منصة مُرضي خدمات تقييم الجاهزية والاستشارات وتجهيز الملفات، ولا تقدّم أي ضمان بالحصول على التمويل أو الاستثمار أو الطرح أو أي موافقات من أي جهة. وتعتمد النتائج على البيانات التي يقدّمها العميل، وعلى الجهات ذات العلاقة، والأنظمة والإجراءات المعمول بها. لا تتحمّل الشركة مسؤولية أي قرار يتخذه العميل أو أي جهة خارجية بناءً على مخرجات المنصة. ومُرضي شركة استشارات مالية مرخّصة بالترخيص رقم FL-457927015 لمزاولة مهنة الاستشارات المالية لغير الأوراق المالية. وهي ليست جهة تمويل، ولا وسيطاً تمويلياً، ولا وسيطاً عقارياً، ولا مؤسسة سوق مالية. ولا تمنح تمويلاً ولا تعتمده ولا توحي بذلك. وإنما تقيس الجاهزية وتجهّز ملف العميل وتبيّن له الجهات التي تنطبق عليه شروطها المعلنة، ثم تعرض ملفه عليها بتكليفٍ خطّي منه، ويبقى قرار التقديم والتعاقد بين العميل والجهة مباشرةً. وأتعاب مُرضي رسمٌ ثابت من العميل وحده مقابل خدمةٍ استشارية تُسلَّم، لا ترتبط بحصوله على تمويل ولا بمقداره؛ ولا تتقاضى مُرضي أي عمولة أو مقابل — مباشر أو غير مباشر — من أي جهة تمويل أو استثمار.</div>
        </section>
