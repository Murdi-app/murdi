...
export const PAGES_BY_JOB: Record<StaffJob, { href: string; label: string; icon: string }[]> = {
  ...
  followup: [
    // ★ وهنا أيضاً (٢٠ سبتمبر): وُضع التبويب أمسِ في قائمة المساعِدة وحدها،
    //   وضي مسجَّلةٌ «متابِعة» — فلم تره. والمكالمات عملها هي: رقمها هو
    //   الرقم الذي يراه العميل. فصار أول شاشةٍ لها كما هو أول شاشةٍ للمساعِدة.
    { href: '/admin/leads', label: 'مكالمات اليوم', icon: '📋' },
