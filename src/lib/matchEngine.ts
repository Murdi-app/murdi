...
export async function runScopedMatch(args: {
  ...
  try {
    ...
    const prompt = 'أنت محلل تمويل خبير في السوق السعودي والخليجي. ابحث في الويب بحثاً دقيقاً ومهنياً عن المنتجات التمويلية المتاحة حالياً للشركة، وقسّم بحثك إلى ثلاث طبقات بالأولوية:\nالطبقة الأولى (الأهم والأوسع): الجهات السعودية المرخّصة من البنك المركزي السعودي (ساما) — غطِّها بعمق.\nالطبقة الثانية: جهات خليجية قد تموّل شركة سعودية (لها فروع في السعودية أو تموّل عبر الحدود).\nالطبقة الثالثة: جهات تمويل دولية قد تموّل شركات في السعودية أو الأسواق الناشئة.\nالجهات المرجعية لكل طبقة:\n' + LICENSED + '\n' + FOREIGN + '\n\n'
      ...
      + '8أ) طريق التقديم إلزامي وهو من أهم ما تنتجه: لكل جهة ومنتج ابحث عن طريقة التقديم الفعلية ولا تفترض أنها البريد. أغلب البنوك لا تقبل طلبات التمويل بالإيميل بل عبر بوابة أو إدارة منشآت أو مدير علاقات. وفي applySteps اكتب خطوات مرقّمة: ادخل إلى كذا، اختر كذا، ارفع كذا، تابع بعد كذا. وفي requiredDocs اذكر مستندات هذا المنتج. ولا تترك هذه الحقول فارغة أبداً؛ إن لم تجد رابطاً فاذكر اسم الإدارة أو القناة.\n'
      ...
      + '{"offers":[{"region":"السعودية أو الخليج أو دولي","provider":"اسم الجهة","product":"اسم المنتج","requirements":"الشروط المعلنة باختصار","verdict":"متأهل أو متأهل بشرط","gaps":["فجوة"],"amountRange":"المبلغ المتوقع","timeline":"زمن الدراسة","saudiPrecedent":"السابقة مع الرابط والسنة أو null","legalPath":"المسار القانوني أو null","applyChannel":"قناة التقديم: بوابة إلكترونية أو إدارة منشآت أو مدير علاقات أو فرع أو بريد","applyUrl":"رابط التقديم المباشر أو null","applySteps":"خطوات التقديم مرقّمة ينفّذها موظف لا يعرف الجهة","requiredDocs":"المستندات المطلوبة لهذا المنتج تحديداً","instrument":"تمويل مباشر أو ضمان أو دعم","engagement":"طرف مقابل أو قناة","source":"رابط المصدر"}]}\n'
