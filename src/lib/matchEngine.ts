...
export async function runScopedMatch(args: {
  ...
  try {
    ...
    const ACQ_SCOPE = 'اقتصر على مشتري الاستحواذ: صناديق تملّك المنشآت الرابحة (search funds وETA)، والشركات المدرجة في السوق الموازية نمو الباحثة عن استحواذات مكمّلة في قطاع العميل.';
