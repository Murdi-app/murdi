...
export async function runScopedMatch(args: {
  ...
  try {
    ...
    const prompt = 'أنت محلل تمويل خبير في السوق السعودي والخليجي. ابحث في الويب بحثاً دقيقاً ومهنياً عن المنتجات التمويلية المتاحة حالياً للشركة، وقسّم بحثك إلى ثلاث طبقات بالأولوية:\nالطبقة الأولى (الأهم والأوسع): الجهات السعودية المرخّصة من البنك المركزي السعودي (ساما) — غطِّها بعمق.\nالطبقة الثانية: جهات خليجية قد تموّل شركة سعودية (لها فروع في السعودية أو تموّل عبر الحدود).\nالطبقة الثالثة: جهات تمويل دولية قد تموّل شركات في السعودية أو الأسواق الناشئة.\nالجهات المرجعية لكل طبقة:\n' + LICENSED + '\n' + FOREIGN + '\n\n'
      ...
      + '7ي) تصنيف المنطقة: أي بنك أو شركة تمويل لها فرع أو كيان مرخّص من البنك المركزي السعودي ويعمل داخل المملكة — مثل فروع بنك أبوظبي الأول والكويت الوطني والإمارات دبي الوطني وقطر الوطني وستاندرد تشارترد — اجعل region = السعودية، لأن العميل يقدّم عليها محلياً كأي بنك سعودي. ولا تجعل region = دولي إلا لجهة تموّل من خارج المملكة بلا كيان مرخّص داخلها.\n'
      + '7ك) عمق التغطية الدولية: المطلوب تغطية دولية واسعة لا عينة. لكل نطاق دولي أو خليجي أخرج ثماني جهات على الأقل إن وجدت، وتوسّع إلى منصات تمويل التجارة وشركات تمويل المورّدين وأذرعة تمويل المصنّعين وبيوت التمويل الإسلامي ومنصات الفواتير العابرة، ولا تكتفِ بالمشهور. الهدف: خمسون جهة دولية على الأقل خارج الخليج تماماً — والجهات الخليجية تُحسب منفصلة ولا تدخل في هذا العدد. قيد حاسم: وكالات ائتمان التصدير وشركات تأمين الائتمان (US EXIM، UKEF، Sinosure، NEXI، K-SURE، SACE، Coface، Allianz، Atradius، EDC، Bpifrance) لا يتجاوز مجموعها خمس جهات من الخمسين، لأنها تضمن المورّد ولا تموّل العميل. والباقي يجب أن يكون جهات تُقرض العميل مباشرةً: بنوك تجارية، ومنصات تمويل فواتير وتجارة، وشركات إقراض مباشر، وأذرعة تمويل المصنّعين، ومموّلي سلاسل الإمداد، وشركات تمويل المعدّات. وزّعها على خمس مناطق دون غيرها: أمريكا، وأوروبا، وبريطانيا، وسنغافورة، والصين — بما لا يقل عن عشر جهات من كل منطقة إن وجدت.\n'
