...
const MODEL_WRITER = 'claude-opus-5';
...
${client.readinessScore && client.readinessScore > 0 ? 'درجة جاهزية رأس المال: ' + client.readinessScore + '/100' + (client.verdict ? ' (' + client.verdict + ')' : '') : ''}
...
5. لا تَعِد بنتيجة مضمونة ولا تُبالغ، لكن اذكر الأرقام الفعلية للعميل بثقة (الإيراد ودرجة الجاهزية) كإشارة قوة — لا تُخفها.
