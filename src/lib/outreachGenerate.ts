...
export async function generateOutreachMessage(
  ...
  const trackWord = isEquity ? 'استثمار' : 'تمويل';
...
${isMezz ? 'إطار إلزامي — دين مساند: العميل يجمع جولة، والجهة تقدّم تمويلاً مربوطاً بالجولة لا حصة ملكية. اذكر حجم الجولة والغرض وأفق السداد ومصادر التدفق. ممنوع عرض أي حصة أو تقييم أو نسبة ملكية على هذه الجهة.' : isEquity
