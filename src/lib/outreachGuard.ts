...
//   • 0570749196 — الرقم الرئيسي للمنصة، وهو ما يراه العملاء
//
...
//
// ★ وتغيّر الرقم العام في ١٤ سبتمبر ٢٠٢٦: كان 0570314005 رقم المالك نفسه
//   وظهر على المنصة، فانتقل إلى المتابِعة (0570749196) لتمسك استفسارات
//   العملاء وحملة جوجل. والقديم يبقى في القائمة لأن رسائل ومستندات سابقة
//   تحمله، ولو حُذف لمنعها الحارسُ بوصفها رقماً غريباً.
export const OFFICE_PHONES = ['0560721110', '0570749196', '0570314005'] as const;

/** الرقم الذي يُعطى لجهة التمويل حين تطلب رقم تواصل */
export const OFFICE_PHONE = '0560721110';

/** الرقم الرئيسي للمنصة — للعملاء والعموم */
export const PLATFORM_PHONE = '0570749196';
