...
export const SERVICES: Record<string, ServiceDef> = {
  ...
  'تجهيز ملف التمويل والتفاوض': {
    ...
    output: 'خطة تجهيز ملف تمويلي: المستندات المطلوبة، نقاط القوة التفاوضية، وغرض التمويل بالأرقام.',
    tracks: ['funding'],
  },
  'إعادة جدولة الديون': {
  ...
  'تجهيز ملف عرض المستثمر والتفاوض': {
    ...
    output: 'خطة ملف عرض استثماري: عناصر العرض، قصة القيمة، الأرقام المحورية، ونقاط التفاوض.',
    tracks: ['investment'],
  },
  ...
  'تجهيز ملف هيئة السوق المالية': {
    definition: 'إعداد ملف الطرح الكامل وفق متطلبات هيئة السوق المالية، بمرافقة المستشار المالي المرخّص.',
    output: 'خطة ملف الطرح: متطلبات الهيئة، الفجوات الحالية، وخطوات التجهيز للإدراج.',
    tracks: ['ipo'],
  },
