...
async function huntAxis(label: string, category: string, instruction: string, count: number, dateContext: string): Promise<{ category: string; leads: Lead[] }> {
  const prompt = 'أنت صائد فرص أعمال خبير ومحترف وعميق التفكير، تعمل لـ د. عبدالحكيم المرضي (حلول المرضي للاستشارات المالية، السعودية). '
    ...
    + '3) سعودية حصراً. ركّز على المنشآت المتوسطة، واستبعد الكيانات العملاقة واليونيكورن والمدعومة من صندوق الاستثمارات العامة والأجنبية. الشركة المدرجة ذات العقد الحديث ليست مستبعدة تلقائياً، لكن لا تفترض حاجتها للتمويل من مجرد الترسية.\n'
  ...
  const axes = [
    {
      ...
      instruction: 'ابحث عن منشآت سعودية **رسا عليها عقد حديثاً** أو فازت بمنافسة خلال التسعين يوماً الماضية. مراتعك: منصة اعتماد وتعميد لترسيات المقاولين، وحسابات الشركات على لينكدإن وتويتر/X التي تعلن فوزها بمشروع، وأخبار المقاولات والتوريد والصيانة والتشغيل، وإعلانات الجهات الحكومية وشبه الحكومية عن ترسية أعمالها، ومنشورات «الحمد لله ترسّى علينا مشروع». '
        + 'القطاعات: مقاولات · توريد · تقنية · صحة · تعليم · خدمات · صيانة وتشغيل · نقل؛ لا تحصر الفرص في المقاولات. '
    ...
    {
      label: 'مقاولو الباطن والمورّدون لعقود مرساة',
      category: 'contract_subcontractors',
      count: 14,
      instruction: 'ابدأ بعقود حديثة معلنة في السعودية ثم ابحث عن الشركات المسماة علناً التي تنفذ جزءاً منها بالباطن أو تورّد موادها أو خدماتها. يشمل ذلك التقنية والأنظمة والنقل والتجهيزات والصيانة والمقاولات. لا تنسب علاقة باطن إلى شركة بالاستنتاج من نشاطها وحده: رابطٌ صريح يثبت دورها وتاريخ حديث مطلوب لكل فرصة direct. إن ظهر عقد رئيسي كبير ولم تُعلن أسماء مقاولي الباطن، اجعله scout، واكتب في entry_angle كيف يستكشف فريقنا الموردين أو شركاء التنفيذ عبر قناة المشتريات العامة؛ لا تخترع أسماء أو بيانات اتصال. خاطب المقاول الرئيسي أولاً بتقديم فائدة له، ثم اطلب إحالة طوعية لمن يحتاج من شبكة مورديه دون إفشاء تفاصيل العقود. ',
    },
    {
