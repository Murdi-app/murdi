...
export async function runDailyHunt(): Promise<{ total: number; byCategory: Record<string, number> }> {
  ...
  const axes = [
    ...
    },
    {
      ...
      count: 12,
      instruction: 'ابحث عن **من يبدأ مشروعاً أو يتوسّع** ويحتاج دراسة جدوى. وأقوى إشارة على الإطلاق: **من قالت له جهة تمويلية أو حاضنة أو صندوق أن يُحضر دراسة جدوى** — هذا عميل جاهز لا يحتاج إقناعاً. '
        + 'ومراتع أخرى: من يعلن نيّته فتح فرع جديد أو خط إنتاج أو مصنع، ومن يسأل علناً عن جدوى مشروع، وإعلانات الحاضنات والمسرّعات التي تشترط دراسة جدوى، وبرامج الدعم الحكومية التي تطلبها ضمن مستنداتها. '
        + 'الشرط: أن تكون هناك **نية جادة ومشروع محدد** — لا تأمّل عام. '
        + 'وفي حقل الإشارة اكتب: ما المشروع، وحجم الاستثمار إن ذُكر، ومن طلب منه الدراسة إن وُجد.',
    },
  ];
